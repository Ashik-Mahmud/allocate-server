...
export class EmailService {
  ...
  async sendWelcomeEmail(
    to: string,
    name: string,
    metadata: { organizationName?: string; initialCredits?: number },
  ) {
  ...
  async sendUpdateStaffProfileInfoByOrganizationEmail(
    to: string,
    name: string,
  ...
  async sendCreditAssignmentEmail(
    to: string,
    name: string,
    credits: number,
    organizationName: string,
