...
export class StaffController {
  ...
  @ApiOperation({
    summary:
      'Create a new staff member in the organization (Organization Admin Only)',
  })
  @ApiResponse({
    status: 201,
  ...
  @ApiOperation({
    summary:
      'Get all staff members in the organization (Organization Admin Only)',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiResponse({ status: 403, description: 'Forbidden.' })
  @ApiOperation({
    summary: 'Get a specific staff member by ID (Organization Admin Only)',
  })
  async getStaffById(
    @Param('id') id: string,
    @CurrentUser() user: User,
  ...
  @ApiResponse({ status: 403, description: 'Forbidden.' })
  @ApiOperation({
    summary: "Update a staff member's information (Organization Admin Only)",
  })
  async updateStaff(
    @Param('id') id: string,
  ...
  @ApiParam({
    name: 'id',
    description: 'The ID of the staff member to manage credits for',
    type: String,
  })
  @ApiBody({ type: ManageCreditsDto })
  @ApiResponse({
    status: 200,
    description: 'Staff member credits managed successfully.',
  })
  @ApiResponse({ status: 400, description: 'Bad Request.' })
  @ApiResponse({ status: 401, description: 'Unauthorized.' })
  @ApiResponse({ status: 403, description: 'Forbidden.' })
  @ApiOperation({
    summary:
      'Manage/Assign credits to a staff member (Organization Admin Only)',
  })
  async manageCredits(
    @Param('id') id: string,
    @Body() manageCreditsDto: ManageCreditsDto,
    @CurrentUser() user: User,
    @Res() res: Response,
  ) {
    ...
    return ResponseUtil.success(
      { message: `Credits for staff member ${id} managed successfully` },
      res,
    );
  }
  ...
  @ApiResponse({
    status: 200,
    description: 'Staff members credits managed successfully.',
  })
  @ApiResponse({ status: 400, description: 'Bad Request.' })
  @ApiResponse({ status: 401, description: 'Unauthorized.' })
  @ApiResponse({ status: 403, description: 'Forbidden.' })
  @ApiOperation({
    summary:
      'Manage/Assign credits to multiple staff members (Organization Admin Only)',
  })
  async manageMultipleStaffCredits(
    @Body() manageCreditsDto: ManageMultipleStaffCreditsDto,
    @CurrentUser() user: User,
    @Res() res: Response,
  ) {
    ...
    return ResponseUtil.success(
      { message: `Credits for staff members managed successfully` },
      res,
    );
  }
  ...
  @ApiParam({
    name: 'id',
    description: 'The ID of the staff member to revoke credits from',
    type: String,
  })
  @ApiBody({ type: ManageCreditsDto })
  @ApiResponse({
    status: 200,
    description: 'Staff member credits revoked successfully.',
  })
  @ApiResponse({ status: 400, description: 'Bad Request.' })
  @ApiResponse({ status: 401, description: 'Unauthorized.' })
  @ApiResponse({ status: 403, description: 'Forbidden.' })
  @ApiOperation({
    summary: 'Revoke credits from a staff member (Organization Admin Only)',
  })
  async revokeCredits(
    @Param('id') id: string,
    @Body() manageCreditsDto: ManageCreditsDto,
    ...
    return ResponseUtil.success(
      { message: `Credits for staff member ${id} revoked successfully` },
      res,
    );
  }
  ...
  @ApiResponse({
    status: 200,
    description: 'Staff credit logs history retrieved successfully.',
  })
  @ApiResponse({ status: 401, description: 'Unauthorized.' })
  @ApiResponse({ status: 403, description: 'Forbidden.' })
  @ApiOperation({
    summary: 'Get the staff credit logs history (Organization Admin Only)',
  })
  @ApiQuery({ name: 'page', required: false, type: Number })
  @ApiQuery({ name: 'limit', required: false, type: Number })
  @ApiQuery({
    ...
    required: false,
    type: String,
    description: 'Search by resource name or action type',
  })
  @ApiQuery({
    name: 'type',
    required: false,
    enum: TransactionType,
    description: 'Filter by transaction type (ALLOCATE, SPEND, REVOKE)',
  })
  async getStaffCreditLogs(
    @CurrentUser() user: User & CurrentUserType,
    @Res() res: Response,
    @Query() query: CreditLogsFilterDto,
  ) {
