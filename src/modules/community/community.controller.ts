...
export class CommunityController {
  ...
  @ApiResponse({
    status: 201,
    description: 'Community hub created successfully.',
  })
  @ApiResponse({ status: 400, description: 'Bad Request.' })
  @ApiOperation({
    summary: 'Post in the Community Hub',
    description: 'Create a new community hub.',
  })
  async createCommunity(
    ...
    const result = await this.communityService.createPostCommunity(
      createPostCommunityDto,
      user,
      ip,
      agent,
  ...
  async updateCommunityPost(
    ...
    const result = await this.communityService.updatePostCommunity(
      postId,
      updatePostCommunityDto,
      user,
      ip,
  ...
  async deleteCommunityPost(
    ...
    const result = await this.communityService.deletePostCommunity(
      postId,
      user,
      ip,
      agent,
  ...
  @ApiResponse({
    status: 200,
    description: 'Community post restored successfully.',
  })
  @ApiResponse({ status: 400, description: 'Bad Request.' })
  @ApiOperation({
    summary: 'Restore a Community Post',
    description: 'Restore a previously deleted community post.',
  })
  async restoreCommunityPost(
    ...
    const result = await this.communityService.restorePostCommunity(
      postId,
      user,
      ip,
      agent,
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve a list of community posts based on the applied filters.',
  })
  ...
  async getCommunityPostById(
    ...
    const result = await this.communityService.getPostCommunityById(
      postId,
      user,
    );
    return ResponseUtil.success(result, res);
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve a list of community posts created by the current user.',
  })
  async getMyCommunityPosts(
    ...
    const result = await this.communityService.getMyPostCommunity(
      filters,
      user,
    );
    return ResponseUtil.paginated(
  ...
  @ApiOperation({
    ...
    description: 'Leave a comment on a specific community post.',
  })
  ...
  @ApiOperation({
    ...
    description: 'Delete a specific comment from a community post.',
  })
  async deleteComment(
    @Res() res: Response,
  ...
  @ApiResponse({
    status: 200,
    description: 'Community post acknowledgment toggled successfully.',
  })
  @ApiResponse({ status: 400, description: 'Bad Request.' })
  @ApiOperation({
    summary: 'Toggle Acknowledgment of a Community Post',
    description:
      'Acknowledge (like) or unacknowledge (unlike) a specific community post.',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Top community authors retrieved successfully.',
  })
  @ApiResponse({ status: 400, description: 'Bad Request.' })
  @ApiOperation({
    summary: 'Get Top Community Authors',
    description:
      'Retrieve a list of top authors in the community hub based on published post count.',
  })
