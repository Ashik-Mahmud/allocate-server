...
export const PostCommunitySchema = z.object({
  ...
  visibility: z
    ...
    .optional()
    .default({ showToStaff: true, showToOrgAdmin: true, showToAdmin: true }),
  isPrivate: z.boolean().optional().default(false),
  postType: z
    .enum(CommunityHubPostType)
    .optional()
    .default(CommunityHubPostType.GENERAL_DISCUSSION),
  status: z
    .enum(CommunityHubStatus)
    .optional()
    .default(CommunityHubStatus.DRAFT),
...
export class CommunityPostFilterDto extends createZodDto(
  CommunityPostFilterSchema,
) {}
export class CreateCommunityPostCommentDto extends createZodDto(
