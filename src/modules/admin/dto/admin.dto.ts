...
export const OrganizationFilterSchema = z.object({
  ...
  verified: z
    .preprocess(
      (val) => String(val).toLowerCase(), // Force to lowercase string first
      z.enum(['true', 'false']),
    )
    .optional()
    .transform((val) =>
  ...
  planType: z
    .enum([PlanType.FREE, PlanType.PRO, PlanType.ENTERPRISE])
    .optional(),
});
...
export class BroadcastAnnouncementDto extends createZodDto(
  BroadcastAnnouncementSchema,
) {}
export class OrganizationFilterDto extends createZodDto(
  OrganizationFilterSchema,
) {}
export class OrganizationCreditTopUpDto extends createZodDto(
  OrganizationCreditTopUpSchema,
) {}
export class AllUserFilterDto extends createZodDto(AllUserFilterSchema) {}
export class SubscriptionTransactionFilterDto extends createZodDto(
  SubscriptionTransactionFilterSchema,
) {}
export class RevenueAnalyticsFilterDto extends createZodDto(
  RevenueAnalyticsFilterSchema,
) {}
export class UserActivityLogFilterDto extends createZodDto(
