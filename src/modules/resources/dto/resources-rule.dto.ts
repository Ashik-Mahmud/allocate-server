...
export class CreateResourceRuleDto extends createZodDto(
  CreateResourceRuleSchema,
) {}
export class UpdateResourceRuleDto extends createZodDto(
  UpdateResourceRuleSchema,
) {}
