...
export class ResourcesController {
  ...
  @ApiResponse({
    status: 403,
    description: 'Forbidden - Subscription plan required',
  })
  ...
  @ApiResponse({
    status: 403,
    description: 'Forbidden - Admin or Client role required',
  })
  async updateResource(
    ...
    const resource = await this.service.updateResource(
      currentUser,
      id,
      updateResourceDto,
      res,
  ...
  @ApiOperation({
    summary: 'Mark resource as under maintenance (ORG_ADMIN only)',
  })
  @ApiResponse({
    status: 200,
    description: 'Resource marked as under maintenance successfully',
  })
  @ApiResponse({ status: 401, description: 'Unauthorized - Token required' })
  @ApiResponse({
    status: 403,
  ...
  async markResourceUnderMaintenance(
    ...
    const resource = await this.service.markResourceUnderMaintenance(
      currentUser,
      id,
      res,
    );
  ...
  @ApiResponse({
    status: 403,
    description: 'Forbidden - ORG_ADMIN role required',
  })
  ...
  @Get('list')
  @ApiOperation({
    summary: 'List resources with pagination, search, and filtering',
  })
  @ApiQuery({
    name: 'page',
    required: false,
  ...
  @ApiQuery({
    ...
    required: false,
    type: String,
    enum: ['name', 'hourly_rate', 'createdAt'],
  ...
  @ApiResponse({
    status: 200,
    description: 'Resources fetched successfully with pagination',
  })
  ...
  async listResources(
    ...
    @Res() res: Response,
  ): Promise<PaginatedResponse<Partial<Resources>>> {
  ...
  @ApiOperation({
    summary:
      'Get all resources with filters and search (for browse resources page)',
  })
  @ApiQuery({
    name: 'search',
    required: false,
  ...
  async getAllResources(
    ...
    @Query() query: ListResourcesQueryDto,
    @Res() res: Response,
  ): Promise<myApiResponse<Partial<Resources>[]>> {
  ...
  @ApiOperation({
    summary:
      'Create/update resource rule for a resource  (ORG_ADMIN role only)',
  })
  @ApiResponse({
    status: 201,
    description: 'Resource rule created/updated successfully',
  })
  @ApiResponse({ status: 401, description: 'Unauthorized - Token required' })
  @ApiResponse({
    status: 403,
  ...
  async createResourceRule(
    ...
    const result = await this.resourcesRuleService.createResourceRule(
      updateResourceRule,
      currentUser,
      id,
      res,
