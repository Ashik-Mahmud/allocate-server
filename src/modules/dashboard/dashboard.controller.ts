...
export class DashboardController {
  ...
  @ApiOperation({
    ...
    description:
      'Returns key metrics and insights about the dashboard for system administrators',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Organization/Staff/Admin dashboard insights',
  })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiOperation({
    summary: 'Get organization insights',
    description:
      'Returns detailed insights and analytics about the organization for STAFF, ADMIN, ORG_ADMIN',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Organization strategic summary for admins',
  })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiOperation({
    summary: 'Get organization insights v2',
    description:
      'Returns executive summary, critical alerts, activity insights, and recommendations for ORG_ADMIN',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Organization/Staff/Admin dashboard metrics',
  })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiOperation({
    summary: 'Get staff insights',
    description:
      'Returns specific metrics related to the staff for STAFF, ADMIN, ORG_ADMIN',
  })
