...
export const CreateSalesInquirySchema = z.object({
  ...
  country: z.string().min(2, 'Invalid country name').optional().nullable(),

  phone: z.string().optional().nullable(),

  org_id: z.string().cuid('Invalid organization ID').optional().nullable(),
});

export class CreateSalesInquiryDto extends createZodDto(
...
export class UpdateSalesInquiryDto extends createZodDto(
...
export class SalesInquiryFiltersDto extends createZodDto(
...
export class SalesInquiryStatsFiltersDto extends createZodDto(
